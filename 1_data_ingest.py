...
schema = StructType(
    [
        ...
        StructField("SavingsAccount", StringType(), True),
        StructField("Multiple", StringType(), True),
        StructField("VirtualWallet", StringType(), True),
        StructField("OverdraftProtection", StringType(), True),
        StructField("AccountTransfer", StringType(), True),
        StructField("OnlineBillPay", StringType(), True),
        StructField("EmailAlerts", StringType(), True),
        StructField("TextAlerts", StringType(), True),
        StructField("Rewards", StringType(), True),
        StructField("Engagement", StringType(), True),
        StructField("PaperlessStatements", StringType(), True),
